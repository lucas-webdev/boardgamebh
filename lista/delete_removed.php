...
if (isset($_GET['id'])) {
    ...
    if (isset($_GET['confirm'])) {
        if ($_GET['confirm'] == 'yes') {
            ...
            header('Location: remover-jogo.php');
            exit;
        }
    }
} else {
...
<div class="content delete">
    ...
    <?php else : ?>
        ...
        <div class="yesno">
            <a class="confirm-delete" href="delete_removed.php?id=<?= $boardgame['id'] ?>&confirm=yes">Sim</a>
            <a class="cancel-delete" href="delete_removed.php?id=<?= $boardgame['id'] ?>&confirm=no">Não</a>
        </div>
    <?php endif; ?>
</div>

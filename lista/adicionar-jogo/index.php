        ...
        <div class="col-12 col-lg-10">
            <div class="form-group form-check">
                ...
                <label class="form-check-label terms" for="agreement">
                    Estou de acordo com as <a class="inheritLink" href="https://bgbh.com.br/regras-lista.html">regras de utilização</a> e ciente que os jogos devem ser retirados/entregues em
                    <b>BELO HORIZONTE</b>
                </label>
            </div>
        </div>
